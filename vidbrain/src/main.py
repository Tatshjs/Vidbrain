...
from search import search_catalog, print_results
...
def main():
    ...
    # ---- search ----
    s = sub.add_parser("search", help="Semantic search over indexed clips.")
    s.add_argument("query", help="Search text (e.g. 'dark bunker people fear')")
    s.add_argument("--db", default="output/catalog.db", help="Path to catalog.db")
    s.add_argument("--top", type=int, default=10, help="How many results to show")
    s.add_argument("--model", default="ViT-B-32", help="CLIP model name")
    s.add_argument("--pretrained", default="laion2b_s34b_b79k", help="OpenCLIP pretrained tag")
